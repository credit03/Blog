...
(function () {
    ...
    CKEDITOR.dom = {};
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, f = /</g, g = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, l = {
            lt: "\x3c",
            gt: "\x3e",
            amp: "\x26",
            quot: '"',
        ...
        CKEDITOR.tools = {
            ...
            cssStyleToDomStyle: function () {
                var a = document.createElement("div").style, e = "undefined" != typeof a.cssFloat ? "cssFloat" : "undefined" != typeof a.styleFloat ? "styleFloat" : "float";
                return function (a) {
            ...
            buildStyleHtml: function (a) {
                a = [].concat(a);
                for (var e,
                         b = [], c = 0; c < a.length; c++)if (e = a[c])/@import|[{}]/.test(e) ? b.push("\x3cstyle\x3e" + e + "\x3c/style\x3e") : b.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + e + '"\x3e');
                return b.join("")
            },
            ...
            transformPlainTextToHtml: function (a, e) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c))var q = "\x3c" + l + "\x3e", m = "\x3c/" + l + "\x3e", c = q + c.replace(d, function () {
                            return m + q
                        }) + m
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
    ...
    CKEDITOR.dom.element.setMarker = function (a, d, b, c) {
        var f = d.getCustomData("list_marker_id") || d.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"), g = d.getCustomData("list_marker_names") || d.setCustomData("list_marker_names", {}).getCustomData("list_marker_names");
        a[f] = d;
        g[b] = 1;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var f = this.$.getBoundingClientRect(), g = e.$.documentElement, q = g.clientTop || d.$.clientTop || 0, w = g.clientLeft || d.$.clientLeft || 0, k = !0;
    ...
    (function () {
        function a(a, b) {
            ...
            e = c.endContainer;
            var f = c.startOffset, A = c.endOffset, v, h = this.guard, p = this.type, n = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var y = e.type == CKEDITOR.NODE_ELEMENT ? e : e.getParent(), z = e.type == CKEDITOR.NODE_ELEMENT ? e.getChild(A) : e.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !y.equals(a)) && (!z || !a.equals(z)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var g = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), E = d.type == CKEDITOR.NODE_ELEMENT ? f ? d.getChild(f - 1) : null : d.getPrevious();
        ...
        var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(), k = CKEDITOR.dom.walker.bookmark(), l = CKEDITOR.dom.walker.temp(), m = function (a) {
        ...
        var e = CKEDITOR.dom.walker.empty(), A = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) {
            var b = {}, c;
    ...
    (function () {
        ...
        var g = {
            ...
            u: 1,
            "var": 1
        }, k = CKEDITOR.dom.walker.bogus(), l = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, m = CKEDITOR.dom.walker.editable(), u = CKEDITOR.dom.walker.ignored(!0);
            ...
            clone: function () {
                ...
                switch (a) {
                        ...
                        for (h = c(h); h || p;) {
                            ...
                            for (; p;)if (z = !1, p.type == CKEDITOR.NODE_COMMENT)p = p.getPrevious(); else {
                                if (p.type == CKEDITOR.NODE_TEXT)J = p.getText(), d.test(J) && (p = null), z = /[\s\ufeff]$/.test(J); else if ((p.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && p.is("br")) && !p.data("cke-bookmark"))if (y && CKEDITOR.dtd.$removeEmpty[p.getName()]) {
                                    J = p.getText();
                                    if (d.test(J))p = null; else for (var E = p.$.getElementsByTagName("*"), C = 0, u; u =
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var m, O, N = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), B = null, I = function (a) {
                ...
                if (!this.collapsed) {
                    ...
                    var d = this.clone(), f = this.startContainer, q = this.endContainer, g = this.startOffset, k = this.endOffset, l = 1, v = 1;
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root), d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), f = c.block, q = d.block, g = null;
                ...
                var a = new CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", this.document), b, c, d, f = this.clone();
                f.optimize();
    ...
    (function () {
        ...
        function h(a, b, c) {
            ...
            if (E.$empty[d] || !a.children.length)"hr" == d && "br" == b ? a.replaceWith(t()) : (a.parent && c.push({
                ...
                b:{
                    h = E[b];
                    for (var p = 0, f = d.length, n; p < f; ++p)if (n = d[p], n.type == CKEDITOR.NODE_ELEMENT && !h[n.name]) {
                        h = !1;
                        break b
                    }
                    h = !0
                ...
                {}, c.push({check: "parent-down", el: a}); else {
                    h = a.parent;
                    for (var p = h.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == h.name, e, g, f = d.length; 0 < f;)n = d[--f], p && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && E.$inline[n.name]) ? (e || (e = new CKEDITOR.htmlParser.element(b), e.insertAfter(a), c.push({
                        check: "parent-down",
                        el: e
        ...
        var O = {styles: 1, attributes: 1, classes: 1}, N = {
            ...
            }, B = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, I = {
                styles: /{([^}]+)}/,
                attrs: /\[([^\]]+)\]/,
                classes: /\(([^\)]+)\)/
            ...
            var g = {}, k = function (b) {
                a.call(this, b, function (a) {
                    ...
                    for (e in a) {
                        ...
                        if (!d[e]) {
                            if (l.icons)for (var x = l.icons.split(","), D = x.length; D--;)CKEDITOR.skin.addIcon(x[D], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + x[D] + ".png");
                            d[e] = 1
                        }
    ...
    (function () {
        ...
        function A(a) {
            ...
            if (f)var p = new RegExp("(?:^|,)(?:" + f.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(p, "");
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.node.prototype = {
            remove: function () {
                ...
                var d = this.parent.children, b = CKEDITOR.tools.indexOf(d, this), c = a.previous = this.previous, f = a.next = this.next;
                c && (c.next = a);
                f && (f.previous = a);
                d[b] = a;
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (g, k, l) {
                ...
                var D = new CKEDITOR.htmlParser, q = k instanceof CKEDITOR.htmlParser.element ? k : "string" == typeof k ? new CKEDITOR.htmlParser.element(k) : new CKEDITOR.htmlParser.fragment, w = [], H = [], t = q, v = "textarea" == q.name, h = "pre" == q.name;
                ...
                D.onText = function (a) {
                    ...
                    var b = t.name, e = b ? CKEDITOR.dtd[b] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
    ...
    (function () {
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, g = Array.prototype.slice.call(arguments, 1), k = this.rules, l = k.length, m, u, e, A;
    ...
    (function () {
        ...
        function q(a, b) {
            var c = [], d = b.config.protectedSource, h = b._.dataStore || (b._.dataStore =
                {id: 1}), f = /<\!--\{cke_temp(comment)?\}(\d*?)--\x3e/g, d = [/<script[\s\S]*?(<\/script>|$)/gi, /<noscript[\s\S]*?<\/noscript>/gi, /<meta[\s\S]*?\/?>/gi].concat(d);
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, h, c = q(c, b), c = e(c, P), c = u(c), c = e(c, Y), c = c.replace(N, "$1cke:$2"), c = c.replace(I, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
        ...
        var J = /<(a|area|img|input|source)\b([^>]*)>/gi, E = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, C = /^(href|src|name)$/i, Y = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
    ...
    (function () {
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, k) {
            var l = this.container, m = this.ui.space("contents"), u = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement;
            ...
            b.on("mode", function () {
                ...
                if (a && a.isInline()) {
                    ...
                    if (d && (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? "top" :
                            "contents"))) {
                        var f = CKEDITOR.tools.getNextId(), d = CKEDITOR.dom.element.createFromHtml('\x3cspan id\x3d"' + f + '" class\x3d"cke_voice_label"\x3e' + d + "\x3c/span\x3e");
                        c.append(d);
            ...
            return function (m, C, B, I) {
                ...
                if (!I.checkReadOnly()) {
                    ...
                    if (L) {
                        ...
                        var R, W;
                        C = x.startContainer;
                        var K = m.endPath.elements[0], X, G = K.getPosition(C), w = !!K.getCommonAncestor(C) && G != CKEDITOR.POSITION_IDENTICAL && !(G & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        C = b(m.dataWrapper, m);
        ...
        t = function () {
            ...
            return {
                list: {
                    ...
                    function a(c) {
                        var e = [], f, h = new CKEDITOR.dom.walker(c), g = c.startPath().contains(d), n = c.endPath().contains(d), p = {};
    ...
    (function () {
        ...
        function k(a, b) {
            ...
            if (c) {
                if (!1 !== b) {
                    var d = a.getDocument().getSelection().getNative(), e = d && "None" != d.type && d.getRangeAt(0), f = x.length;
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var f = e.document, h = CKEDITOR.document, g = e.editable(), p = f.getBody(), l = f.getDocumentElement(), m = g.isInline(), q, B;
            ...
            getNative: function () {
                ...
                var a = A ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, h, g = b.duplicate(), k = 0, l = e.length - 1, B = -1, n, m; k <= l;)if (B = Math.floor((k + l) / 2), f = e[B], g.moveToElementText(f), n = g.compareEndPoints("StartToStart", b), 0 < n)l = B - 1; else if (0 > n)k = B + 1; else return {
                            container: d,
                            offset: a(f)
                        };
            ...
            if (c.collapsed)e = H(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(u))r = null, l = !0; else {
                        ...
                        if (v && m && CKEDITOR.dtd.$block[x])for (var w = r, y = f(w), z = void 0, C = y.length, E = 0, w = C && new CKEDITOR.dom.range(w.getDocument()); E < C; ++E) {
                        ...
                        if (y)if (z = r.getParent(), y = h, C = g, E = k, !z || !(z.getDtd() || CKEDITOR.dtd.span)[C] && !E || y.parentRule && !y.parentRule(z))l = !0; else {
                            if (t ||
                                ...
                                for (var x = r, P; (l = !x.getNext(Y)) && (P = x.getParent(), n[P.getName()]) && d(P, q, h, N);)x = P;
                                t.setEndAfter(x)
                            }
                        } else l = !0;
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            var d = this.$.parentNode, b = d.childNodes.length, c = this.getLength(), f = this.getDocument(), g = new CKEDITOR.dom.text(this.$.splitText(a), f);
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, k = c[d ? "endContainer" : "startContainer"], l = d ? "endOffset" : "startOffset", m = g ? c.document.getById(a.startNode) : a.startNode;
