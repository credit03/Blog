...
CKEDITOR.dialog.add("radio", function (b) {
    return {
        title: b.lang.forms.checkboxAndRadio.radioTitle, minWidth: 350, minHeight: 140, onShow: function () {
            ...
            var a, c = this.radioButton, b = !c;
            b && (a = this.getParentEditor(), c = a.document.createElement("input"), c.setAttribute("type", "radio"));
            b && a.insertElement(c);
        ...
        contents: [{
            ...
            elements: [{
                ...
                commit: function (a) {
                    ...
                    if (CKEDITOR.env.ie) {
                        ...
                        d != e && (d = CKEDITOR.dom.element.createFromHtml('\x3cinput type\x3d"radio"' +
                            (e ? ' checked\x3d"checked"' : "") + "\x3e\x3c/input\x3e", b.document), c.copyAttributes(d, {
                            type: 1,
                            checked: 1
                        }), d.replace(c), b.getSelection().selectElement(d), a.element = d)
                ...
                commit: function (a) {
                    a = a.element;
                    this.getValue() ? a.setAttribute("required",
