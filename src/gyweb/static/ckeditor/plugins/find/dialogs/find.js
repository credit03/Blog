...
(function () {
            ...
            contents: [{
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        onClick: function () {
                            var a = this.getDialog();
                            e.replace(a, a.getValueOf("replace", "txtFindReplace"), a.getValueOf("replace", "txtReplace"), a.getValueOf("replace", "txtReplaceCaseChk"), a.getValueOf("replace", "txtReplaceWordChk"), a.getValueOf("replace", "txtReplaceCyclic")) ||
                            alert(f.notFoundMsg)
                        }
                    }]
                }, {
                    ...
                    children: [{
                        ...
                        onClick: function () {
                            ...
                            for (c.fire("saveSnapshot"); e.replace(a, a.getValueOf("replace", "txtFindReplace"), a.getValueOf("replace",
                                "txtReplace"), a.getValueOf("replace", "txtReplaceCaseChk"), a.getValueOf("replace", "txtReplaceWordChk"), !1, !0););
    ...
    }, B = ["find", "replace"], v = [["txtFindFind",
        "txtFindReplace"], ["txtFindCaseChk", "txtReplaceCaseChk"], ["txtFindWordChk", "txtReplaceWordChk"], ["txtFindCyclic", "txtReplaceCyclic"]];
